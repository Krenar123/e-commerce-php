...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div style="font-family: 'Poppins', sans-serif; font-weight:bold;" class="card-header">{{ __('Login') }}</div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label style="font-family: 'Poppins', sans-serif;" class="form-check-label" for="remember">
                                        {{ __('Remember Me') }}
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a style="font-family: 'Poppins', sans-serif;" class="btn btn-link" href="{{ route('password.request') }}">
