        ...
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    @else
                    <div style="display:flex; align-items:center;font-size:25px;margin-right:10px; color: #ff4747; float:right;">
                        <a style="margin-right: 20px; float:right;color: #ff4747;font-family: 'Poppins', sans-serif;" class="btn btn-light" href="{{ route('admin.index') }}">Dashboard</a>
                    </div>
                    @endif
                    ...
                    <div class="col-md-3 col-sm-12" style="margin-bottom:20px;">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if ( Auth::check() && ( ( Auth::user()->role == "Market owner" && Auth::user()->id == $product->user_id) || (Auth::user()->role == "Admin") ))
