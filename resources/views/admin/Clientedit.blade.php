                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.update', $user->id ) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="client_address" value="{{ $user->client_address }}" type="client_address" class="form-control @error('client_address') is-invalid @enderror" name="client_address" required autocomplete="client_address">
